...
class MARKET_PRESET:
    ...
    def __init__(self):
        ...
        self.table = {'AG': {'name': '白银',
                             ...
                             'exchange': 'SHFE',
                             'commission_coeff_peramount': 0.0005,
                             'commission_coeff_pervol': 0,
                             'commission_coeff_today_peramount': 0.0005,
                             'commission_coeff_today_pervol': 0},
                      'AL': {'name': '铝',
                             'unit_table': 5,
                             'price_tick': 5.0,
                      ...
                      'BU': {'name': '石油沥青',
                             ...
                             'commission_coeff_pervol': 0,
                             'commission_coeff_today_peramount': 0.003,
                             'commission_coeff_today_pervol': 0},
                      'CU': {'name': '铜',
                             'unit_table': 5,
                             'price_tick': 10.0,
                      ...
                      'PB': {'name': '铅',
                             ...
                             'sell_frozen_coeff': 0.08,
                             'exchange': 'SHFE',
                             'commission_coeff_peramount': 0.0004,
                             'commission_coeff_pervol': 0,
                             'commission_coeff_today_peramount': 0.0,
                             'commission_coeff_today_pervol': 0},
                      'RB': {'name': '螺纹钢',
                      ...
                      'RU': {'name': '天然橡胶',
                             ...
                             'sell_frozen_coeff': 0.09,
                             'exchange': 'SHFE',
                             'commission_coeff_peramount': 0.00045,
                             'commission_coeff_pervol': 0,
                             'commission_coeff_today_peramount': 0.00045,
                             'commission_coeff_today_pervol': 0},
                      'SN': {'name': '锡',
                             'unit_table': 1,
                             'price_tick': 10.0,
                      ...
                      'I': {'name': '铁矿石',
                            ...
                            'sell_frozen_coeff': 0.08,
                            'exchange': 'DCE',
                            'commission_coeff_peramount': 0.0006,
                            'commission_coeff_pervol': 0,
                            'commission_coeff_today_peramount': 0.0006,
                            'commission_coeff_today_pervol': 0},
                      'J': {'name': '冶金焦炭',
                            'unit_table': 100,
                            'price_tick': 0.5,
                            ...
                            'sell_frozen_coeff': 0.08,
                            'exchange': 'DCE',
                            'commission_coeff_peramount': 0.0018,
                            'commission_coeff_pervol': 0,
                            'commission_coeff_today_peramount': 0.0018,
                            'commission_coeff_today_pervol': 0},
                      'JD': {'name': '鲜鸡蛋',
                             'unit_table': 10,
                             'price_tick': 1.0,
                             ...
                             'sell_frozen_coeff': 0.07,
                             'exchange': 'DCE',
                             'commission_coeff_peramount': 0.0015,
                             'commission_coeff_pervol': 0,
                             'commission_coeff_today_peramount': 0.0015,
                             'commission_coeff_today_pervol': 0},
                      'JM': {'name': '焦煤',
                             'unit_table': 60,
                             'price_tick': 0.5,
