...
financial_dict = {
    ...
    # 11. 单季度财务指标
    '230营业收入': 'operatingRevenue',
    '231营业利润': 'operatingProfit',
    '232归属于母公司所有者的净利润': 'netProfitBelongingToTheOwnerOfTheParentCompany',
    '233扣除非经常性损益后的净利润': 'netProfitAfterExtraordinaryGainsAndLosses',
    '234经营活动产生的现金流量净额': 'netCashFlowsFromOperatingActivities',
    '235投资活动产生的现金流量净额': 'netCashFlowsFromInvestingActivities',
    '236筹资活动产生的现金流量净额': 'netCashFlowsFromFinancingActivities',
    '237现金及现金等价物净增加额': 'netIncreaseInCashAndCashEquivalents',
    # 12.股本股东
    '238总股本': 'totalCapital',
