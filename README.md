...
![version](https://img.shields.io/badge/Version-%201.0.10-orange.svg)
...
![Pypi](https://img.shields.io/badge/Pypi-%201.0.10-blue.svg)
...
- [x] 基于[pytdx](https://github.com/rainx/pytdx)各种爬虫的数据源 
- [x] 实时交易数据,实时tick
- [x] 基于Vue.js的前端网站
