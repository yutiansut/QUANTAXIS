...
- [升级日志](#升级日志)
    - [新的功能:](#新的功能)
        ...
        - [1.59 QA_fetch_get_stock_transaction('tdx',code,start,end,count,ip,port)](#159-qa_fetch_get_stock_transactiontdxcodestartendcountipport)
    - [巨大改动/重构](#巨大改动重构)
...
### 1.59 QA_fetch_get_stock_transaction('tdx',code,start,end,count,ip,port)
2017/8/18
