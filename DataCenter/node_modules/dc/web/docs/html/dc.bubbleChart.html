...
<head>
	...
	<title>dc.js Class: bubbleChart</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: bubbleChart</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="bubbleChart"><span class="type-signature"></span>new bubbleChart(parent, <span class="optional">chartGroup</span>)</h4>
...
<dd>
    ...
    <div class="description">
        <p>A concrete implementation of a general purpose bubble chart that allows data visualization using the<br>following dimensions:</p>
<ul>
...
<dl class="details">
        ...
        <dd class="mixes"><ul>
            ...
            <li><a href="dc.bubbleMixin.html">dc.bubbleMixin</a></li>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="bubble-chart.js.html">bubble-chart.js</a>,
				 <a href="bubble-chart.js.html#sunlight-1-line-1">line 1</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type"><a href="dc.bubbleChart.html">dc.bubbleChart</a></span>
    ...
    <pre class="sunlight-highlight-javascript">// create a bubble chart under #chart-container1 element using the default global chart group
var bubbleChart1 = dc.bubbleChart(&#x27;#chart-container1&#x27;);
// create a bubble chart under #chart-container2 element using chart group A
var bubbleChart2 = dc.bubbleChart(&#x27;#chart-container2&#x27;, &#x27;chartGroupA&#x27;);</pre>
...
<hr>
<dt>
    <h4 class="name" id="elasticRadius"><span class="type-signature"></span>elasticRadius(<span class="optional">elasticRadius</span>)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Turn on or off the elastic bubble radius feature, or return the value of the flag. If this<br>feature is turned on, then bubble radii will be automatically rescaled to fit the chart better.</p>
    </div>
...
<table class="params table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>elasticRadius</code></td>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="bubble-chart.js.html">bubble-chart.js</a>,
				 <a href="bubble-chart.js.html#sunlight-1-line-40">line 40</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="sortBubbleSize"><span class="type-signature"></span>sortBubbleSize(<span class="optional">sortBubbleSize</span>)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Turn on or off the bubble sorting feature, or return the value of the flag. If enabled,<br>bubbles will be sorted by their radius, with smaller bubbles in front.</p>
    </div>
...
<table class="params table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>sortBubbleSize</code></td>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="bubble-chart.js.html">bubble-chart.js</a>,
				 <a href="bubble-chart.js.html#sunlight-1-line-58">line 58</a>
			</li>
		</ul>
	</dd>
