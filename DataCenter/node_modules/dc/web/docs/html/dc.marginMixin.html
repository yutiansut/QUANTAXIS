...
<head>
	...
	<title>dc.js Mixin: marginMixin</title>
...
<div class="row">
	...
	<h1 class="page-title">Mixin: marginMixin</h1>
<section>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Margin is a mixin that provides margin utility functions for both the Row Chart and Coordinate Grid<br>Charts.</p></div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="margin-mixin.js.html">margin-mixin.js</a>,
				 <a href="margin-mixin.js.html#sunlight-1-line-1">line 1</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="margins"><span class="type-signature"></span>margins(<span class="optional">margins</span>)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Get or set the margins for a particular coordinate grid chart instance. The margins is stored as<br>an associative Javascript array.</p>
    </div>
...
<table class="params table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>margins</code></td>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="margin-mixin.js.html">margin-mixin.js</a>,
				 <a href="margin-mixin.js.html#sunlight-1-line-13">line 13</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type"><a href="dc.marginMixin.html">dc.marginMixin</a></span>
    ...
    <pre class="sunlight-highlight-javascript">var leftMargin = chart.margins().left; // 30 by default
chart.margins().left = 50;
leftMargin = chart.margins().left; // now 50</pre>
