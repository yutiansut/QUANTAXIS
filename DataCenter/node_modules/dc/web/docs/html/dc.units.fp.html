...
<head>
	...
	<title>dc.js Namespace: fp</title>
...
<div class="row">
	...
	<h1 class="page-title">Namespace: fp</h1>
<section>

<header>
    
        <h2>
            <span class="ancestors"><a href="dc.html">dc</a><a href="dc.units.html">.units</a>.</span>
		...
		<ul class="dummy">
			<li>
				<a href="core.js.html">core.js</a>,
				 <a href="core.js.html#sunlight-1-line-361">line 361</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".precision"><span class="type-signature">&lt;static> </span>precision(precision)</h4>
...
<dd>
    ...
    <div class="description">
        <p>This function generates an argument for the Coordinate Grid Chart<br>.xUnits function specifying that the x values are floating-point<br>numbers with the given precision.<br>The returned function determines how many values at the given precision will fit into the range<br>supplied in its start and end parameters.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core.js.html">core.js</a>,
				 <a href="core.js.html#sunlight-1-line-367">line 367</a>
			</li>
		</ul>
	</dd>
	...
	<dd class="tag-see">
		<ul>
			<li>coordinateGridMixin.xUnits</li>
			</ul>
	</dd>
...
<span class="param-type">function</span>
    ...
    <pre class="sunlight-highlight-javascript">// specify values (and ticks) every 0.1 units
chart.xUnits(dc.units.fp.precision(0.1)
// there are 500 units between 0.5 and 1 if the precision is 0.001
var thousandths = dc.units.fp.precision(0.001);
thousandths(0.5, 1.0) // returns 500</pre>
