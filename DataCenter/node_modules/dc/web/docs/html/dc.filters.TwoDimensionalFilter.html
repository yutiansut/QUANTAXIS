...
<head>
	...
	<title>dc.js Class: TwoDimensionalFilter</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: TwoDimensionalFilter</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="TwoDimensionalFilter"><span class="type-signature"></span>new TwoDimensionalFilter(filter)</h4>
...
<dd>
    ...
    <div class="description">
        <p>TwoDimensionalFilter is a filter which accepts a single two-dimensional value.  It is used by the<br>heat map chart to include particular cells as they are clicked.  (Rows and columns are<br>filtered by filtering all the cells in the row or column.)</p>
<p>Its <code>filterType</code> is 'TwoDimensionalFilter'</p>
    </div>
		...
		<ul class="dummy">
			<li>
				<a href="filters.js.html">filters.js</a>,
				 <a href="filters.js.html#sunlight-1-line-45">line 45</a>
			</li>
		</ul>
	</dd>
