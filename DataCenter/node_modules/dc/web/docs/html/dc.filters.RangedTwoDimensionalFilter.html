...
<head>
	...
	<title>dc.js Class: RangedTwoDimensionalFilter</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: RangedTwoDimensionalFilter</h1>
<section>

<header>
    
        <h2>
            <span class="ancestors"><a href="dc.html">dc</a><a href="dc.filters.html">.filters</a>.</span>
...
<hr>
<dt>
    <h4 class="name" id="RangedTwoDimensionalFilter"><span class="type-signature"></span>new RangedTwoDimensionalFilter(filter)</h4>
...
<dd>
    ...
    <div class="description">
        <p>The RangedTwoDimensionalFilter allows filtering all values which fit within a rectangular<br>region. It is used by the scatter plot to implement rectangular brushing.</p>
<p>It takes two two-dimensional points in the form <code>[[x1,y1],[x2,y2]]</code>, and normalizes them so that<br><code>x1 &lt;= x2</code> and <code>y1 &lt;= y2</code>. It then returns a filter which accepts any points which are in the<br>rectangular range including the lower values but excluding the higher values.</p>
<p>If an array of two values are given to the RangedTwoDimensionalFilter, it interprets the values as<br>two x coordinates <code>x1</code> and <code>x2</code> and returns a filter which accepts any points for which <code>x1 &lt;= x &lt;
x2</code>.</p>
<p>Its <code>filterType</code> is 'RangedTwoDimensionalFilter'</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="filters.js.html">filters.js</a>,
				 <a href="filters.js.html#sunlight-1-line-70">line 70</a>
			</li>
		</ul>
	</dd>
