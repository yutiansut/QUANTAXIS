...
ac=user.get_account(a_1)
ac.frequence=QA.FREQUENCE.FIFTEEN_MIN
market.start()
...
"""
# 登陆交易
market.login(QA.BROKER_TYPE.BACKETEST, a_1, ac)
for code in ['000001','000002','000004','600010','000007']:
    market.insert_order(account_id=a_1, amount=1000, price=None, amount_model=QA.AMOUNT_MODEL.BY_AMOUNT, time='2017-12-01 09:45:00', code=code,
